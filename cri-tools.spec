...
Source0  : https://github.com/kubernetes-sigs/cri-tools/archive/v1.26.1/cri-tools-1.26.1.tar.gz
...
%prep
%setup -q -n cri-tools-1.26.1
cd %{_builddir}/cri-tools-1.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678975673
