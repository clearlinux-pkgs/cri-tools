...
Version  : 1.33.0
Release  : 74
URL      : https://github.com/kubernetes-sigs/cri-tools/archive/v1.33.0/cri-tools-1.33.0.tar.gz
Source0  : https://github.com/kubernetes-sigs/cri-tools/archive/v1.33.0/cri-tools-1.33.0.tar.gz
...
%prep
%setup -q -n cri-tools-1.33.0
cd %{_builddir}/cri-tools-1.33.0
pushd ..
cp -a cri-tools-1.33.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745335765
...
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/prometheus/client_golang/internal/github.com/golang/gddo/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/98bd4176f4779516009b9effebe10231c836470d || :
...
cp %{_builddir}/cri-tools-%{version}/vendor/go.opentelemetry.io/auto/sdk/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/7df059597099bb7dcf25d2a9aedfaf4465f72d8d || :
...
cp %{_builddir}/cri-tools-%{version}/vendor/go.uber.org/automaxprocs/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/ae487ab6d8aed743a235c977604faffd070ba2c3 || :
...
cp %{_builddir}/cri-tools-%{version}/vendor/sigs.k8s.io/yaml/goyaml.v3/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/b74b3b31bc15ad5e94fc1947d682aa3d84132fce || :
cp %{_builddir}/cri-tools-%{version}/vendor/sigs.k8s.io/yaml/goyaml.v3/NOTICE %{buildroot}/usr/share/package-licenses/cri-tools/9522d95b2b9b284285cc3fb6ecc445aa3ee5e785 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
...
/usr/share/package-licenses/cri-tools/ae487ab6d8aed743a235c977604faffd070ba2c3
