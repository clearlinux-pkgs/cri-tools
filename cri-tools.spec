...
Version  : 1.25.0
Release  : 52
URL      : https://github.com/kubernetes-sigs/cri-tools/archive/refs/tags/v1.25.0.tar.gz
Source0  : https://github.com/kubernetes-sigs/cri-tools/archive/refs/tags/v1.25.0.tar.gz
...
%prep
%setup -q -n cri-tools-1.25.0
cd %{_builddir}/cri-tools-1.25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661553753
...
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/PuerkitoBio/purell/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/33cd8e150548e595fbe201c6ca9df582976e71db
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/PuerkitoBio/urlesc/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/7f7a12bcfc16fab2522aa1a562fd3d2aee429d3b
...
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/grpc-ecosystem/grpc-gateway/LICENSE.txt %{buildroot}/usr/share/package-licenses/cri-tools/c2add16c875ec7abad9c453d0a0c325dc814e8f2
...
cp %{_builddir}/cri-tools-%{version}/vendor/go.opentelemetry.io/contrib/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
...
cp %{_builddir}/cri-tools-%{version}/vendor/go.opentelemetry.io/otel/exporters/otlp/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
...
cp %{_builddir}/cri-tools-%{version}/vendor/go.opentelemetry.io/otel/sdk/export/metric/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
cp %{_builddir}/cri-tools-%{version}/vendor/go.opentelemetry.io/otel/sdk/metric/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
...
/usr/share/package-licenses/cri-tools/33cd8e150548e595fbe201c6ca9df582976e71db
