...
Source0  : https://github.com/kubernetes-sigs/cri-tools/archive/refs/tags/v1.23.0.tar.gz
...
%prep
%setup -q -n cri-tools-1.23.0
cd %{_builddir}/cri-tools-1.23.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659647727
...
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/googleapis/gnostic/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
...
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/nxadm/tail/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/a792f3e236631b46c9ea1a9f86ab3a6c24b17c89
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/nxadm/tail/ratelimiter/Licence %{buildroot}/usr/share/package-licenses/cri-tools/15e225f105ead05a4d06cdf7723bb6ec11e92304
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/onsi/ginkgo/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/9f1b6690bcfc732123ae209c90c62f2ba80dfcb0
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/onsi/ginkgo/reporters/stenographer/support/go-colorable/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/5ca808f075931c5322193d4afd5a3370c824f810
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/onsi/ginkgo/reporters/stenographer/support/go-isatty/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/5b53018d7f0706e49275a92d36b54cfbfbb71367
...
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/shurcooL/sanitized_anchor_name/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/c111106ab0af1873aa6350f797759fe1519c8be1
...
cp %{_builddir}/cri-tools-%{version}/vendor/github.com/urfave/cli/v2/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/62e85c543bad57a03eff756c0cfcb4bd26b77a4a
...
cp %{_builddir}/cri-tools-%{version}/vendor/gopkg.in/tomb.v1/LICENSE %{buildroot}/usr/share/package-licenses/cri-tools/178b27feb961b28990b377da59e9d43d868a0a6f
